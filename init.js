...
if( FN<81000 || FN>83000 )
	console.error( 'Вероятно не сте дали правилна стойност FN. Не правете домашно с грешно FN.' );
...
function random( a, b )
{
	return Math.floor( a + (b-a+1)*THREE.Math.seededRandom( ) );
}
